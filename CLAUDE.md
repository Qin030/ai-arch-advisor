...
- **定位語的改動要 M1 本人確認過才能合併。** 「不代為判定」「轉列待確認」
  ...
  草稿，但完成條件是兩段：改完先在 `docs/proposal-gaps.md` 對應那列標成
  「已改，待 M1 確認措辭」；**M1 本人確認並留下紀錄後，才能改成「已改，
  M1 已確認措辭」，否則仍未完成。**
- **這道關卡是額外的作者確認，不取代任何既有審查。** M2 的宣稱一致性審查
  與實質否決權照舊，PR 仍要 M2 核准、仍由另一位成員人工合併。M1 確認了
  措辭不等於這個 PR 可以合併。
